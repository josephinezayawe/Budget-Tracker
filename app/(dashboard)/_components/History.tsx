...
function History({ userSettings }: { userSettings: userSettings }) {
  ...
  // --- DEBUG LOGS START ---
  console.log("History.tsx: History component rendering");
  console.log("History.tsx: userSettings:", userSettings);
  console.log("History.tsx: initial period state:", period);
  // --- DEBUG LOGS END ---
